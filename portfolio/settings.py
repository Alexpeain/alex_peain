...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',  # This should remain as is
        ...
        'HOST': config('DATABASE_HOST', default='localhost'),  # Database host
        'PORT': config('DATABASE_PORT', default=''), # Database port (optional)
    }
}
